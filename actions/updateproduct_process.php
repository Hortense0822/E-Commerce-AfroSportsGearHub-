...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($product_cat) && !empty($product_brand) && !empty($product_title) && !empty($product_price) && !empty($product_keyword) && isset($_FILES['product_image'])) {
        // Handle image upload
        ...
        if (move_uploaded_file($tempname, $folder)) {
            ...
            if (update_product($product_id,$product_cat, $product_brand, $product_title, $product_price, $filename, $product_keyword)) {
